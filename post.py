...
prompt = """Tu es un expert en recrutement et coach carriere francais.

Choisis toi-meme un sujet original sur la recherche d emploi, le CV, la lettre de motivation ou les entretiens.
Varie le style et l angle a chaque fois.
